;; doom-nebula-blue-theme.el --- inspired from the doom one and modus themes -*- no-byte-compile: t; -*-
;;; Commentary:
(require 'doom-themes)

;;; Code:
(defgroup doom-nebula-blue-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom doom-nebula-blue-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-nebula-blue-theme
  :type 'boolean)

(defcustom doom-nebula-blue-padded-modeline doom-themes-padded-modeline
...
;; name           gui       256       16
  ((bg         '("#001627" nil       nil))
   (bg-alt     '("#00121e" nil       nil))
   (base0      '("#00192B" "#101010" "black"        ))
   (base1      '("#001B30" "#21212d" "brightblack"  ))
   (base2      '("#001E36" "#21212d" "brightblack"  ))
   (base3      '("#00213B" "#1e1e1e" "brightblack"  ))
   (base4      '("#003761" "#5e5e5e" "brightblack"  ))
   ...
   ;; modeline settings
   (-modeline-pad
    (when doom-nebula-blue-padded-modeline
      (if (integerp doom-nebula-blue-padded-modeline) doom-nebula-blue-padded-modeline 4)))
   ...
   (modeline-bg  (if doom-nebula-blue-brighter-modeline base4 base3))
   (modeline-bg-l (if doom-nebula-blue-brighter-modeline base4 base3))
  ...
  (((all-the-icons-dblue &override) :foreground dark-cyan)
   ...
   ;; Treemacs
   (treemacs-root-face :foreground highlight :weight 'ultra-bold :height (* doom-nebula-blue-variable-font-height-multiplier 1.2))
   (doom-themes-treemacs-root-face :foreground highlight :weight 'ultra-bold :height (* doom-nebula-blue-variable-font-height-multiplier 1.2))
...
;;; doom-nebula-blue-theme.el ends here
